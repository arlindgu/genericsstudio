      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col">
          ...
          <p>
            ...
            meaningful ways. I strive to push the boundaries of creativity and
            technology, crafting experiences that are not only visually striking
            but also highly functional and user-centric.
          </p>
          <p>
            I believe in the power of collaboration and transparency. My process
            is built on open communication, working closely with clients to
            understand their needs and goals. This approach allows me to create
            tailored solutions that truly resonate with their audience.
          </p>
        </div>
        <div>
          <p className="italic">
