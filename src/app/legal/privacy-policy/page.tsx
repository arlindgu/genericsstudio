    ...
    <main className='flex flex-col gap-8'>
        ...
        <div>
          ...
          <ul className="list-disc pl-4">
            ...
            <li>
              particularly sensitive data (e.g. biometric data or information
              about your health).
            </li>
          </ul>
        </div>
        <div>
          ...
          <p>
            ...
            proportionate processing.If, in exceptional cases, we are unable to
            comply with these principles, the data processing may still be
        ...
        <div>
          ...
          <p>
            ...
            this consent unless we have another justification.You can revoke
            your consent at any time by sending an e-mail to the address given
        ...
        <div>
          ...
          <ul className="list-disc pl-4">
            ...
            <li>
              IT service provider (web hosting, support, cloud services, website
              design, etc.);
            </li>
          ...
          <p>
            We ensure that these third parties and our affiliates comply with
            the requirements of data protection and treat your personal data
          ...
          <p>
            ...
            corresponding icons). If you click on the icons, you will be
            redirected to our social media channels.In this case, the social
            media providers learn that you are accessing their platform from our
            website. The social media providers can use the data collected in
            this way for their own purposes. We would like to point out that we
          ...
          <p>
            ...
            companies are obligated to data protection to the same extent as we
            are. The transfer may take place worldwide.If the level of data
            protection does not correspond to that in Switzerland, we carry out
            a prior risk assessment and ensure contractually that the same level
            of protection is guaranteed as in Switzerland (for example, by means
            of the new standard contractual clauses of the EU Commission or
            other legally prescribed measures). If our risk assessment is
            negative, we take additional technical measures to protect your
            data. You can access the EU Commission's standard contractual
        ...
        <div>
          ...
          <p>
            ...
            we store when you visit our website is kept for twelve months. An
            exception is made for analysis and tracking data, which may be kept
            longer.We store contract data for longer, as we are obliged to do so
            by legal regulations. In particular, we must retain business
            communications, concluded contracts and accounting records for up to
            10 years. As far as we no longer need such data from you to perform
        ...
        <div>
          ...
          <p>
            ...
            alteration.Our contractual partners and employees who have access to
            your data are obliged to comply with data protection regulations. In
            some cases, it will be necessary for us to pass on your requests to
            companies affiliated with us. In these cases, too, your data will be
            treated confidentially.Within our website, we use the SSL (Secure
        ...
        <div>
          ...
          <p>
            ...
            together with proof of identity to info@generics.studio.You also
          ...
          <ul className="list-disc pl-4">
            ...
            <li>
              you have disclosed data in connection with the conclusion or
              performance of a contract.
            </li>
          </ul>
          <p>
            We may restrict or refuse to provide information or data if this
            conflicts with our legal obligations, our own legitimate interests,
            public interests or the interests of a third party.The processing of
            your request is subject to the statutory processing period of 30
            days. However, we may extend this period due to a high volume of
            requests, for legal or technical reasons, or because we need more
          ...
          <p>
            ...
            oblige us to store the data for a longer period or to retain it
            unchanged or if your request conflicts with a legal
            requirement.Please note that exercising your rights may be in
            conflict with contractual agreements and may have corresponding
          ...
          <p>
            ...
            the competent supervisory authority. The competent supervisory
        ...
        <div>
          ...
          <ul className="list-disc pl-4">
            ...
            <li>
              the operating system of the computer with which the URL is
              accessed;
            </li>
          ...
          <p>
            ...
            stored in order to guarantee the functionality of the website and to
        ...
        <div>
          ...
          <p>
            ...
            web beacons about the use of this website (including the user's IP
            ...
            Google will not merge your IP address with other data stored by
            you.You may refuse the use of cookies by selecting the appropriate
            ...
            website.Furthermore, you can deactivate interest-based ads on Google
            as well as interest-based Google ads on the web (within the Google
            display network) in your browser by activating the "Off" button at
            https://www.google.com/settings/ads or by deactivating at
            https://www.aboutads.info/choices/. You can find more information
        ...
        <div>
          ...
          <p>
            ...
            View, CA 94043, USA (hereinafter "Google"). Google Ads enables us to
        ...
        <div>
          ...
          <p>
            ...
            2, Ireland, a subsidiary of Meta Inc., 1601 Willow Road, Menlo Park,
            CA 94025, USA.If you contact us via WhatsApp Business Chat, your
            cell phone number and the content of your message, as well as any
            other data you may have provided, will be transmitted to WhatsApp
            and processed there. We receive this data and use it to respond to
            your request.WhatsApp uses cookies and other technologies to provide
            ...
            to WhatsApp's privacy policy. We recommend that you read this policy
        ...
        <div>
          ...
          <p>
            ...
            ("Cloudflare"). Cloudflare Stream is a video streaming platform that
            allows us to efficiently host, stream and monetize videos.When you
            watch videos on our website that are provided via Cloudflare Stream,
            various data, including your IP address, information about the
            browser you are using, date and time of access, and interaction data
            with the video, are transmitted to and stored by Cloudflare. This
        ...
        <div>
          ...
          <p>
            ...
            to embed fonts. By integrating these fonts, your browser will
            establish a connection to Google's servers when you visit our
            website in order to download the fonts and display them
            correctly.Through this connection, data, in particular your IP
            address and information about the browser you are using, may be
            transmitted to Google and stored on Google servers. These servers
            may be located in the USA or other countries.If you want to prevent
            the transfer of data within the Google Fonts API, you can block
            access to the domain fonts.googleapis.com in your browser settings.
            Please note that in this case our website may not be displayed
            correctly.
          </p>
        </div>
    </main>
